...
function getWebsiteDomain(currentUrl) {
  try {
...
function buildSimplificationScript(conversionOptions) {
  return `
    (() => {
...
async function simplifyCurrentPage(webContents, currentUrl) {
  const conversionOptions = {
    extractMainContent: true,
    refifyUrls: true,
    includeMetaData: 'basic',
    websiteDomain: getWebsiteDomain(currentUrl),
  };

  const script = buildSimplificationScript(conversionOptions);
...
module.exports = { simplifyCurrentPage };
